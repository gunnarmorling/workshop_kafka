...
public class Location extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6586722961360894604L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Location\",\"namespace\":\"example.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"rating\",\"type\":[\"int\",\"null\"],\"default\":0}]}");
   ...
   */
  public Location(java.lang.CharSequence name, java.lang.Integer rating) {
    this.name = name;
    this.rating = rating;
  }
   ...
   */
  public static example.avro.Location.Builder newBuilder() {
    return new example.avro.Location.Builder();
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static example.avro.Location.Builder newBuilder(example.avro.Location.Builder other) {
    return new example.avro.Location.Builder(other);
  }
   ...
   * @return A new Location RecordBuilder
   */
  public static example.avro.Location.Builder newBuilder(example.avro.Location other) {
    return new example.avro.Location.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Location>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(example.avro.Location.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(example.avro.Location other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Location.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Location.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Location.Builder setRating(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Location.Builder clearRating() {
      rating = null;
